      ...
      if (newPassword === retypeNewPassword) {
        if (strongRegex.test(newPassword)) {
          ...
          const res = await axios.put(
            `${apiUrl}/user/reset_password/${params.resetToken}`,
            {
            ...
            <CRow className="justify-content-center mt-3 mb-4">
              ...
              <CCol md="11" className="my-4">
                <CForm onSubmit={onSubmitResetPassword}>
                  <CInputGroup className="mb-4">
                    ...
                    <CInputGroupAppend>
                      ...
                      >
                        <CIcon
                          name={
                            newPasswordSecure ? "cil-sun" : "cil-low-vision"
                          }
                        />
                      </CInputGroupText>
                    </CInputGroupAppend>
                  ...
                  <CInputGroup className="mb-4">
                    ...
                    <CInputGroupAppend>
                      <CInputGroupText
                        className="l-b-none pw-show-hide"
                        onClick={() =>
                          setRetypeNewPasswordSecure(!retypeNewPasswordSecure)
                        }
                      >
                        <CIcon
                          name={
                            retypeNewPasswordSecure
                              ? "cil-sun"
                              : "cil-low-vision"
                          }
                        />
                  ...
                  <CRow className="mt-2">
                    <CCol sm="12" md="12">
                      <CButton type="submit" className="px-4 w-100 jptr-btn">
