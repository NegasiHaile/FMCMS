    ...
    <CRow>
      ...
      <CCol sm="6" lg="3">
        <CWidgetBrand
          color="twitter"
          rightHeader="973k"
          rightFooter="Delivered"
          leftHeader="92"
          leftFooter="Instore"
        >
          <CIcon name="cil-memory" height="52" className="my-4" />
          <ChartLineSimple
            className="position-absolute w-100 h-100"
            backgroundColor="rgba(255,255,255,.1)"
      ...
      <CCol sm="6" lg="3">
        <CWidgetBrand
          color="linkedin"
          rightHeader="500+"
          rightFooter="Completed"
          leftHeader="292"
          leftFooter="Processing"
        >
          <CIcon name="cil-star" height="52" className="my-4" />
          <ChartLineSimple
            className="position-absolute w-100 h-100"
            backgroundColor="rgba(255,255,255,.1)"
      ...
      <CCol sm="6" lg="3">
        ...
        >
          <CIcon name="cil-asterisk-circle" height="52" className="my-4" />
          <ChartLineSimple
            className="position-absolute w-100 h-100"
            backgroundColor="rgba(255,255,255,.1)"
